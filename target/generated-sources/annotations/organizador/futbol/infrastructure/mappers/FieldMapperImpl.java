...
public class FieldMapperImpl implements FieldMapper {
    ...
    @Override
    public Field toField(FieldEntity fieldEntity) {
        if ( fieldEntity == null ) {
            return null;
        }
    ...
    @Override
    public Iterable<Field> toFields(Iterable<FieldEntity> fieldEntities) {
        if ( fieldEntities == null ) {
            return null;
        }

        ArrayList<Field> iterable = new ArrayList<Field>();
        for ( FieldEntity fieldEntity : fieldEntities ) {
            iterable.add( toField( fieldEntity ) );
        }
    ...
    @Override
    public FieldEntity toFieldEntity(Field field) {
        if ( field == null ) {
            return null;
        }
